...
A single effective timescale implements a limited memory policy: fast updates track short-lived changes but pass more high-frequency variation, while slow updates smooth fluctuations and preserve context at the cost of lag or missed rapid changes~\citep{oppenheim2010discrete,brown1959statistical}.
...
\subsection{Kernel Mismatch Bound}
\label{sec:theory:kernelbound}

Many SSM-based encoders admit a locally linear convolutional view~\citep{gu2022s4,gu2023mamba}:
\begin{equation}
