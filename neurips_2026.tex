...
Following~\citet{bae2025spatiotemporal}, we model the BOLD power spectral density as a piecewise power-law across configurable frequency regimes; the main experiments use the default $K=3$ setting (ultra-low, low, high), separated by knee frequencies $(f_1, f_2)$.
...
\begin{equation}
P(f) \propto f^{-\beta_k}, \quad f \in [f_{k-1}, f_k], \quad k = 1,\dots,K,
\end{equation}
where $(f_1, f_2)$ are the default two knee frequencies separating three frequency regimes.
