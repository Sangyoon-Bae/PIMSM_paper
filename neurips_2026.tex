...
\end{equation}
where knee frequencies $f_k$ are spectral transition points that separate temporal regimes. These knees turn multi-scale dynamics into observable target timescales for a model, rather than a qualitative statement that the signal is ``complex.''
