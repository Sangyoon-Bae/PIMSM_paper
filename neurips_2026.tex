...
PIMSM supports temporal-scale alignment as a practical inductive bias for scientific sequence models. By coupling spectrum-derived knees to scale-specific $\Delta$ values and anchoring both $\Delta$ and $A$ in acquisition units, the backbone learns a memory policy tied to the signal's physical organization rather than to a split-specific hyperparameter setting.
