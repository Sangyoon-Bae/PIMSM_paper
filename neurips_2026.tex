...
We model the power spectral density of each multivariate time series as a piecewise power-law across configurable frequency regimes, following frequency-resolved modeling of multiscale fMRI dynamics~\citep{bae2025spatiotemporal} but applying the same procedure to both neural and meteorological signals. The main experiments use the default $K=3$ setting, separated by knee frequencies $(f_1, f_2)$.
