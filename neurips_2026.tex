...
\textbf{(a)} SpectralHyperNet estimates spectral regimes from the input and uses them to parameterize a multi-scale SSM, whose scale-specific states are fused by cross-scale attention.
